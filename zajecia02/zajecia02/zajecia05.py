...
#Przy okazji: formatowanie string�w: 
...
#Korzystanie z argument�w do skryptu:
import sys
...
#wskaz�wka: # Convert all of the input values from strings to floats
...
'''
#cwiczenie:Zgadnij co zwr�ci print(portfolio[0]). Utw�rz plik 
